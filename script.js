...
(function () {
  ...
  const I18N = {
    tr: {
      ...
      'blogp.search': 'Yazılarda ara…', 'blogp.allAuthors': 'Tüm Yazarlar', 'blogp.allTags': 'Tüm Etiketler', 'blogp.empty': 'Aradığınız ölçütlere uyan yazı bulunamadı.',
      ...
      'cta.schedulerSub': 'Uzman ekibimizle ücretsiz keşif görüşmesi planlayın. İhtiyaçlarınıza özel çözüm tasarlayalım.',
      ...
      'footer.kvkk': 'KVKK Aydınlatması', 'footer.rights': '© 2026 Form Elektrik İnş.Müh.A.Ş — Tüm hakları saklıdır.',
      ...
      'cookie.text': 'Bu site, deneyiminizi iyileştirmek için çerezler kullanır. Ayrıntılar için <a href="/kvkk" target="_blank" rel="noopener">KVKK Aydınlatma Metnimizi</a> inceleyebilirsiniz.',
    ...
    en: {
      ...
      'blogp.search': 'Search articles…', 'blogp.allAuthors': 'All Authors', 'blogp.allTags': 'All Tags', 'blogp.empty': 'No posts match your filters.',
      ...
      'cta.schedulerSub': 'Schedule a free discovery call with our experts. We will design the right solution for your needs.',
      ...
      'footer.kvkk': 'Privacy Notice', 'footer.rights': '© 2026 Form Elektrik — All rights reserved.',
      ...
      'cookie.text': 'This site uses cookies to improve your experience. See our <a href="/kvkk" target="_blank" rel="noopener">Privacy Notice</a> for details.',
